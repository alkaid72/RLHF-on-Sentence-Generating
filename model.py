...
def compute_rank_list_loss(rank_rewards_list: List[List[torch.tensor]], device='cpu') -> torch.Tensor:
    ...
    The rank loss is calculated by the reward list of the given ordered (from high to low) ranklist.
    The sum of the scores of all higher-ranked sentences minus the score difference of lower-ranked sentences, and take the negative.
